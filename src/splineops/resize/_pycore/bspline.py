...
def _beta_scalar(x: float, degree: int) -> float:
    ...
    if degree == 0:
        ...
        if x < 0.5:
            ...
            betan = (
                x * (x * (x * (5.0 / 6.0 - x * (1.0 / 6.0)) - 5.0 / 4.0) + 5.0 / 24.0)
                + 55.0 / 96.0
            )
        elif x < 2.5:
            x -= 2.5
        ...
        if x < 1.0:
            ...
            betan = (
                ...
                * (
                    x
                    * (x * (x * (x * (1.0 / 24.0) - 3.0 / 8.0) + 5.0 / 4.0) - 7.0 / 4.0)
                    + 5.0 / 8.0
                )
                + 17.0 / 40.0
            )
        ...
        if x < 0.5:
            t = x * x
            betan = (
                t * (t * (7.0 / 48.0 - x * (1.0 / 36.0)) - 77.0 / 192.0)
                + 5887.0 / 11520.0
            )
        elif x < 1.5:
            betan = (
                ...
                * (
                    ...
                    * (
                        x
                        * (
                            x * (x * (x * (1.0 / 48.0) - 7.0 / 48.0) + 21.0 / 64.0)
                            - 35.0 / 288.0
                        )
                        - 91.0 / 256.0
                    )
            ...
            betan = (
                ...
                * (
                    ...
                    * (
                        x
                        * (
                            x * (x * (7.0 / 60.0 - x * (1.0 / 120.0)) - 21.0 / 32.0)
                            + 133.0 / 72.0
                        )
                        - 329.0 / 128.0
                    )
        ...
        if x < 1.0:
            ...
            betan = (
                a2
                * (a2 * (a2 * (x * (1.0 / 144.0) - 1.0 / 36.0) + 1.0 / 9.0) - 1.0 / 3.0)
                + 151.0 / 315.0
            )
        elif x < 2.0:
            betan = (
                ...
                * (
                    ...
                    * (
                        ...
                        * (
                            x
                            * (
                                x * (x * (1.0 / 20.0 - x * (1.0 / 240.0)) - 7.0 / 30.0)
                                + 0.5
                            )
                            - 7.0 / 18.0
                        )
                ...
                * (
                    ...
                    * (
                        ...
                        * (
                            x
                            * (
                                x * (x * (x * (1.0 / 720.0) - 1.0 / 36.0) + 7.0 / 30.0)
                                - 19.0 / 18.0
                            )
                            + 49.0 / 18.0
                        )
...
def beta(x, n: int):
    ...
    if n == 4:
        ...
        a = ax[m1]
        out[m1] = (
            a * (a * (a * (5.0 / 6.0 - a * (1.0 / 6.0)) - 5.0 / 4.0) + 5.0 / 24.0)
            + 55.0 / 96.0
        )
    ...
    if n == 5:
        ...
        out[m1] = (
            a
            * (
                a * (a * (a * (a * (1.0 / 24.0) - 3.0 / 8.0) + 5.0 / 4.0) - 7.0 / 4.0)
                + 5.0 / 8.0
            )
            + 17.0 / 40.0
        )
    ...
    if n == 6:
        ...
        t = ax[m0] * ax[m0]
        out[m0] = (
            t * (t * (7.0 / 48.0 - ax[m0] * (1.0 / 36.0)) - 77.0 / 192.0)
            + 5887.0 / 11520.0
        )
        ...
        out[m1] = (
            ...
            * (
                ...
                * (
                    a
                    * (
                        a * (a * (a * (1.0 / 48.0) - 7.0 / 48.0) + 21.0 / 64.0)
                        - 35.0 / 288.0
                    )
                    - 91.0 / 256.0
                )
        ...
        out[m2] = (
            ...
            * (
                ...
                * (
                    a
                    * (
                        a * (a * (7.0 / 60.0 - a * (1.0 / 120.0)) - 21.0 / 32.0)
                        + 133.0 / 72.0
                    )
                    - 329.0 / 128.0
                )
    ...
    if n == 7:
        ...
        out[m0] = (
            a2
            * (
                a2 * (a2 * (ax[m0] * (1.0 / 144.0) - 1.0 / 36.0) + 1.0 / 9.0)
                - 1.0 / 3.0
            )
            + 151.0 / 315.0
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        a
                        * (
                            a * (a * (1.0 / 20.0 - a * (1.0 / 240.0)) - 7.0 / 30.0)
                            + 0.5
                        )
                        - 7.0 / 18.0
                    )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        a
                        * (
                            a * (a * (a * (1.0 / 720.0) - 1.0 / 36.0) + 7.0 / 30.0)
                            - 19.0 / 18.0
                        )
                        + 49.0 / 18.0
                    )
