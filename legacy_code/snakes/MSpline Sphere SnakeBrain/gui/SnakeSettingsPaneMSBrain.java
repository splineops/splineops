 ...
 */
public class SnakeSettingsPaneMSBrain extends CollapsiblePanel implements
	...
	/** Default constructor. */
	public SnakeSettingsPaneMSBrain(String title, BIGSnake3DMSBrain bigSnake) {
		super(title);
		bigSnake_ = bigSnake;
		...
		numControlPointsSpinner_
				.setModel(new SpinnerNumberModel(new Integer(4),
						new Integer(4), new Integer(10), new Integer(1)));
		...
		gammaSpinner_.setModel(new SpinnerNumberModel(0.0, 0.0,
		...
		maxIterationsSpinner_.setModel(new SpinnerNumberModel(
				new Integer(1500), new Integer(1), null, new Integer(1)));
	...
	public SphereSnakeTargetTypeMSBrain getTargetBrightness() {
		switch (targetBrightnessComboBox_.getSelectedIndex()) {
		case 0:
			return SphereSnakeTargetTypeMSBrain.DARK;
		case 1:
			return SphereSnakeTargetTypeMSBrain.BRIGHT;
		}
		return null;
	}
	...
	public SphereSnakeEnergyTypeMSBrain getEnergyType() {
		...
		case 0:
			return SphereSnakeEnergyTypeMSBrain.CONTOUR;
		case 1:
			return SphereSnakeEnergyTypeMSBrain.REGION;
		case 2:
			return SphereSnakeEnergyTypeMSBrain.MIXTURE;
		}
		return null;
	}
	...
	public void setSnakeParameters(SphereSnakeParametersMSBrain snakeParameters) {
