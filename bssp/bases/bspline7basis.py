...
class BSpline7Basis(SplineBasis):
    ...
    def __init__(self):
        ...
        super(BSpline7Basis, self).__init__(support=support, poles=poles)
    ...
    def eval(x: npt.ArrayLike) -> npt.NDArray:
        ...
        y = np.where(
            ...
            1 / 5040 * (7 * x_abs * (x_abs * (x_abs * (x_abs * (
                    x_abs * ((x_abs - 20) * x_abs + 168)
                    - 760) + 1960) - 2760) + 1736) - 1112),
            y
        )
        ...
        y = np.where(
            ...
            1 / 5040 * (2472 - 7 * x_abs * (x_abs * (x_abs * (
                    3 * (x_abs - 6) * x_abs * ((x_abs - 6) * x_abs + 20)
                    + 280) + 72) + 56)),
            y
        )
        ...
        y = np.where(
            x_abs < 1,
            1 / 144 * (x_abs ** 5 - 4 * x_abs ** 4 + 16 * x_abs ** 2 - 48)
            * x_abs ** 2 + 151/315,
            y
        )
